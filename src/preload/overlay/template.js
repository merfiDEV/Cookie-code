...
'.cuckoo-btn {',
'  flex: 1; padding: 9px 10px; border: 1px solid transparent; border-radius: 10px;',
...
'  background: rgba(139,147,255,0.12); color: #a8afff;',
'  border-color: rgba(139, 147, 255, 0.5);',
'}',
'.cuckoo-btn-secondary:hover { background: rgba(139, 147, 255, 0.28); color: #fff; border-color: rgba(139, 147, 255, 0.75); transform: translateY(-1px); }',
'.cuckoo-btn-text {',
