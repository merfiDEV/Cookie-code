...
'    <button id="cuckoo-btn-minimize" class="cuckoo-btn-icon" title="' + t('overlay.btn.minimize') + '">×</button>',
'  </div>',
'  <div class="cuckoo-body">',
'    <div class="cuckoo-section cuckoo-project-dir-section">',
'      <div class="cuckoo-project-dir-row">',
'        <span class="cuckoo-label">' + t('overlay.label.currentDir') + '</span>',
'        <button id="cuckoo-btn-change-dir" class="cuckoo-btn-change-dir" title="' + t('overlay.btn.changeDir.title') + '">' + t('overlay.btn.changeDir') + '</button>',
'      </div>',
'      <div id="cuckoo-project-dir-display" class="cuckoo-project-dir-display">',
'        <span class="cuckoo-dir-path">' + t('overlay.dir.notSelected') + '</span>',
'      </div>',
'    </div>',
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section cuckoo-token-section">',
'      <label class="cuckoo-label">' + t('overlay.label.convTokens') + '</label>',
...
'      <button id="cuckoo-btn-init" class="cuckoo-btn cuckoo-btn-primary">' + t('overlay.btn.init') + '</button>',
'    </div>',
'    <div class="cuckoo-actions">',
...
'    </div>',
'    <div class="cuckoo-actions">',
'      <button id="cuckoo-btn-immersive" class="cuckoo-btn cuckoo-btn-secondary" title="' + t('overlay.btn.immersive.title') + '">' + t('overlay.btn.immersive') + '</button>',
'    </div>',
'    <div class="cuckoo-actions">',
'      <button id="cuckoo-btn-manual-parse" class="cuckoo-btn cuckoo-btn-secondary" title="' + t('overlay.btn.manualParse.title') + '">' + t('overlay.btn.manualParse') + '</button>',
'    </div>',
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section cuckoo-session-section">',
'      <div class="cuckoo-session-header">',
'        <span class="cuckoo-label">' + t('overlay.label.sessions') + '</span>',
'        <button id="cuckoo-btn-refresh-sessions" class="cuckoo-btn-refresh-sessions" title="' + t('overlay.btn.refreshSessions') + '">' + t('overlay.btn.refreshSessions') + '</button>',
'      </div>',
'      <div id="cuckoo-session-list" class="cuckoo-session-list">',
'        <div class="cuckoo-session-empty">' + t('overlay.sessions.empty') + '</div>',
'      </div>',
'    </div>',
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section">',
'      <label class="cuckoo-label">' + t('overlay.label.sendDelay') + '</label>',
...
'          <span class="cuckoo-blur-value">' + t('overlay.label.delayRange') + '</span>',
...
'        </div>',
'      </div>',
'      <button id="cuckoo-btn-save-delay" class="cuckoo-btn-text" style="align-self:flex-end;">' + t('overlay.btn.saveDelay') + '</button>',
'    </div>',
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section">',
'      <label class="cuckoo-label">' + t('overlay.label.task') + '<span id="cuckoo-task-status" class="cuckoo-task-status cuckoo-hidden"><span class="cuckoo-spinner"></span>' + t('overlay.task.running') + '<button id="cuckoo-btn-kill" class="cuckoo-btn-kill" title="' + t('overlay.task.kill.title') + '">' + t('overlay.task.kill') + '</button></span></label>',
'      <pre id="cuckoo-cmd-preview" class="cuckoo-cmd-preview">' + t('overlay.cmd.none') + '</pre>',
'    </div>',
'    <div id="cuckoo-result-section" class="cuckoo-section cuckoo-hidden">',
'      <label class="cuckoo-label">' + t('overlay.label.result') + '</label>',
...
'        <summary class="cuckoo-label">' + t('overlay.label.history') + '</summary>',
'        <div id="cuckoo-history-list" class="cuckoo-history-list"></div>',
'        <button id="cuckoo-btn-clear" class="cuckoo-btn-text">' + t('overlay.btn.clearHistory') + '</button>',
'      </details>',
'    </div>',
'  </div>',
'</div>',
...
'    <button id="cuckoo-wm-close" class="cuckoo-btn-icon" title="' + t('wm.btn.close') + '">×</button>',
'  </div>',
'  <div class="cuckoo-wm-body">',
'    <div class="cuckoo-actions">',
'      <button id="cuckoo-wm-new-window" class="cuckoo-btn cuckoo-btn-primary">' + t('wm.btn.newWindow') + '</button>',
'    </div>',
'    <div class="cuckoo-divider"></div>',
'    <div class="cuckoo-section">',
'      <div class="cuckoo-session-header">',
'        <span class="cuckoo-label">' + t('wm.label.list') + '</span>',
'        <button id="cuckoo-wm-refresh" class="cuckoo-btn-refresh-sessions" title="' + t('wm.btn.refresh') + '">' + t('wm.btn.refresh') + '</button>',
'      </div>',
...
'    <button id="cuckoo-mcp-close" class="cuckoo-btn-icon" title="' + t('wm.btn.close') + '">×</button>',
'  </div>',
'  <div class="cuckoo-wm-body cuckoo-mcp-body">',
'    <div class="cuckoo-mcp-left">',
'      <div class="cuckoo-session-header">',
'        <span class="cuckoo-label">' + t('mcp.label.configured') + '</span>',
'        <button id="cuckoo-mcp-refresh" class="cuckoo-btn-refresh-sessions" title="' + t('wm.btn.refresh') + '">🔄</button>',
'      </div>',
...
'      <div class="cuckoo-actions">',
'        <button id="cuckoo-mcp-save" type="button" class="cuckoo-btn cuckoo-btn-primary">' + t('mcp.btn.save') + '</button>',
'      </div>',
'    </div>',
'  </div>',
'</div>',
...
'    <button id="cuckoo-btn-first-close" class="cuckoo-btn-icon cuckoo-first-time-close" title="' + t('wm.btn.close') + '">×</button>',
'    <div class="cuckoo-first-time-text">' + t('firstTime.text') + '</div>',
'    <div class="cuckoo-actions">',
'      <button id="cuckoo-btn-first-init" class="cuckoo-btn cuckoo-btn-primary">' + t('overlay.btn.init') + '</button>',
'    </div>',
'  </div>',
'</div>',
  ].join('\n');
